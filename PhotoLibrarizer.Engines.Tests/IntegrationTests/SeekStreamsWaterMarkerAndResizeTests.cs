...
namespace PhotoLibrarizer.Engines.Tests.IntegrationTests
{
    ...
    public class SeekStreamsWaterMarkerAndResizeTests
    {
        ...
        public void ConvertFileToStream_Resize_Mark_ValidFile_ReturnsStream()
        {
            ...
            var files = filesSeeker.GetFilesInPath("/Users/edwardflores/Pictures/Wacken/2025/post/2025.08.02/Extra/Done", new List<string> {".jpg", ".jpeg"}, false);
            ...
            foreach (var file in files)
            {
                ...
                var resizedStream = resizingImages.TryConvertImage(stream, 2000, 2000, out var streamSmall, out string errorMessage2);
        ...
        [Test]
        public void ConvertFileToStream_Mark_ValidFile_ReturnsStream()
        {
            // Arrange watermark
            string watermarkImagePath = "/Users/edwardflores/Pictures/f60642b79ba667ed85798d85d7bc891c.png";
            ...
            // Arrange seek files
            IFilesSeeker filesSeeker = new FilesSeeker();
            var files = filesSeeker.GetFilesInPath("/Users/edwardflores/Pictures/Photos/converted", new List<string> {".jpg"}, false);
            ...
            foreach (var file in files)
            {
                ...
                // Arrange watermark
                IWaterMarker waterMarker = new WaterMarker();
                var watermarkedStream = waterMarker.AddWatermarkAndGetStream(stream, watermarkImagePath);
